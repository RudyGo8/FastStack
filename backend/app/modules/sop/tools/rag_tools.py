...
from app.modules.sop.rag.runtime import get_knowledge_tool_call_this_turn, increase_knowledge_tool_calls_this_turn, set_last_rag_context
...
def search_knowledge_base(query: str) -> str:
    ...
    if calls_this_turn >= 1:
        return "本轮已经调用过知识库了 请基于已有结果直接回答"

    increase_knowledge_tool_calls_this_turn()

    from app.modules.sop.rag import run_rag_graph
