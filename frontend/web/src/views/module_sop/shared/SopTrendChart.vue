...
function render(): void {
  ...
  const firstForecastIndex = props.data.findIndex((item) => item.submit_forecast !== null);
  const forecastStart =
  ...
  chart.setOption(
    {
      ...
      xAxis: {
        ...
        axisTick: { show: false },
        axisLabel: { rotate: 0, color: "#64748b", fontSize: 12, margin: 12 },
      },
      yAxis: {
        type: "value",
        name: "单位：台",
